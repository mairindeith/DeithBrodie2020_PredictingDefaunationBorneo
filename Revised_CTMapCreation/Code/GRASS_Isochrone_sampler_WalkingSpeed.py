...
resist_infile = os.path.join(infiles,'ResistanceMap','Resistance_hpk_09.Sep.2019_walkingOnly.tif')
...
### Modified Sep 9, 2019 to only look at villages in Sarawak
node_path = os.path.join(infiles,'SourceSinks_WalkingOnly_VillageSabahOther',str(date+"_Nodes"))
