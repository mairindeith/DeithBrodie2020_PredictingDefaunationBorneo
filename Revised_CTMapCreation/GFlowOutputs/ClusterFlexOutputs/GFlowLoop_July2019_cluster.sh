...
for file in $(ls ./SourceSinks/17.Jul.2019_Nodes/NodesTXT/nodes*.txt)[1]; do
	...
	mpiexec -n 10 /Linux/bin/gflow \
		-habitat ./ResistanceMap/Resistance_hpp_17.Jul.2019_cell1.asc \
...
mv GFlowOutputs/Jul2019/Preprocessing/$output_file_full GFlowOutputs/Jul2019/TmpOutputs/${output_file}_${multiplier}.asc && 
cp GFlowOutputs/Jul2019/TmpOutputs/intermediate_cumulative GFlowOutputs/Jul2019/FinalOutputs/$final_output && 
